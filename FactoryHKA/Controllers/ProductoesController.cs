...
public class ProductoesController : Controller
{
    ...
    public async Task<IActionResult> Index(int page = 1)
    {
        ...
        var vm = new PaginacionViewModel<Producto>
        {
            Items = productos,
            PaginaActual = page,
    ...
    public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,Precio,Stock,Activo")] Producto producto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int? id, [Bind("Id,Nombre,Descripcion,Precio,Stock,Activo")] Producto producto)
    {
        if (id != producto.Id)
        {
            return NotFound();
